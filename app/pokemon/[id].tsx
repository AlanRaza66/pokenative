    ...
    return <RootView style={{ backgroundColor: colorType }}>
        <View >
            ...
            <Card style={[styles.card]}>
                <Row style={[styles.centered]} gap={16}>
                    {types?.map((type) => {
                        return <PokemonType name={type.type.name} key={type.type.name} />
                    })}
                </Row>
                <ThemedText variant="subtitle1" style={[styles.centered, { color: colorType }]}>About</ThemedText>
                <Row>
                ...
                {/* Stats */}
                <ThemedText variant="subtitle1" style={[styles.centered, { color: colorType }]}>Base Stats</ThemedText>
            </Card>
        </View>
    </RootView>
}
