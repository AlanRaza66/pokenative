        ...
        <>
            <Pressable onPress={onButtonPress}>
                <View
                    ...
                    <Image source={value === "id" ? require("@/assets/images/number.png") : require("@/assets/images/name.png")} width={16} height={16} />
                </View>
            </Pressable>
            <Modal animationType="fade" transparent visible={isModalVisible} onRequestClose={onClose}>
                ...
                <View style={[styles.popup, { backgroundColor: colors.tint, ...position }]}>
                    ...
                    <Card style={[styles.card]}>
                        {
                            options.map((o) => {
                                return <Pressable onPress={() => onChange(o.value)}><Row key={o.value} gap={8}>
